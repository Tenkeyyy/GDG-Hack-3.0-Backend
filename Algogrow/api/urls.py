...
urlpatterns = [
    ...
    path("Levels/", views.LevelListCreate.as_view(), name="level-view-create"),
    path("Badges/", views.BadgeListCreate.as_view(), name="badge-view-create"),
    ...
    path("User/<int:pk>/", views.UserUpdateView.as_view(), name="user-update-view"),
    path("Course/<int:pk>/", views.CourseUpdateView.as_view(), name="course-update-view"),
    path("Level/<int:pk>/", views.LevelUpdateView.as_view(), name="level-update-view"),
    path("Badge/<int:pk>/", views.BadgeUpdateView.as_view(), name="badge-update-view"),
]
